...
from modules import regression, svm, neural_net, clustering, trees, challenges, arena
...
opcion = st.sidebar.radio(
    "Selecciona un tema:",
    ("1. Regresión Lineal", "2. SVM (Vectores de Soporte)", "3. Redes Neuronales (En Vivo)", "4. Clustering (K-Means)", "5. Árboles (Lógica Simbólica)", "🏆 MODO RETO", "⚔️ LA ARENA (Innovación)")
)
...
if opcion == "1. Regresión Lineal":
    ...
    challenges.render()
elif opcion == "⚔️ LA ARENA (Innovación)":
    arena.render()
else:
